...
namespace UdpServer
{
    class UdpClient
    {
        public System.Net.EndPoint clientEnd{ get; private set; }
        ...
        private void ReceiveCallBack(IAsyncResult ar)
        {
            ...
            if (msgLength == 0)
            {
                ...
                UserSocket.Close();
                UdpProgram.clients.Remove(this);
                return;
            }


            reveiveQueue.Enqueue(dataBuffer.Take(msgLength).ToArray());
        ...
        void BroadMessage(byte[] msg)
        {
            foreach(var client in UdpProgram.clients)
            {
                MessageMgr.SendMessage(client.UserSocket, msg);
            }
        }
        ...
        public UdpClient(EndPoint socket)
        {
            this.clientEnd = socket;
        }
    }
}
